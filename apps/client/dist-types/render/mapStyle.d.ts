 ...
 */
export declare function applyPatchTexture(
  tx: Texture,
  halfExtent: number,
  info: CustomTexInfo,
  uv?: FaceStyle,
 ...
 */
export declare function buildMapLights(scene: Scene, lights: MapLight[] | undefined): void
export declare function disposeMapLights(scene: Scene): void
export {}
