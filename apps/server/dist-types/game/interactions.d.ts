import type { ClientCraft, ClientDrop, ClientInvMove, ClientUse, ClientWeld, ServerActionResult } from '@hobo/protocol';
 ...
 */
export declare function handleUse(session: PlayerSession, world: GameWorld, msg: ClientUse, nowMs: number, canManipulate: (entity: GameEntity) => boolean): GatherResult;
...
export declare function handleWeld(session: PlayerSession, world: GameWorld, msg: ClientWeld, canManipulate: (entity: GameEntity) => boolean): WeldOutcome;
